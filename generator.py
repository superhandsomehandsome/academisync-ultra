...
4. 中西医结合：中文文献通常来自中医期刊，请从中抽取中医理论（如“肺与大肠相表里”）、证型和方剂组成；英文文献多聚焦分子机制与实验数据，请将其中的信号通路、蛋白表达、IC50/剂量等转化为中文综述中的“机制解析”内容，实现中西医融合。
5. 引用规范：文中观点必须严格对应参考文献 [1], [2] 等编号。
"""
...
- 对中文文献报告的中药方剂，要写清“方剂名称-主要成分-靶向通路/分子”的对应关系；对英文文献中的实验结果，要补充关键指标（如炎症因子水平、肺功能/病理评分变化）。
...
6. 数据与对象：若文献中有剂量、模型、指标，尽量在文中点出（如“LPS诱导的ALI大鼠”“150 mg/kg”“IL-1β、IL-6、TNF-α水平”），增强可信度。
"""
